...
conteinerSuperior.append(titulo, tituloSuperior, talleBusto, talleBajoBusto, calcularTalleSuperior, resultadoTalleSuperiores);
...
calcularTalleSuperior.addEventListener("click", event => {
    ...
    const talleCorpinio = (bajoBusto >= 62 && bajoBusto <= 72 && busto >= 75 && busto <= 95) ? "S" :
        (bajoBusto >= 73 && bajoBusto <= 80 && busto >= 75 && busto <= 100) ? "M" :
        (bajoBusto >= 81 && bajoBusto <= 90 && busto >= 75 && busto <= 100) ? "L" :
        (bajoBusto >= 91 && bajoBusto <= 102 && busto >= 89 && busto <= 112) ? "XL" :
        (bajoBusto >= 103 && bajoBusto <= 108 && busto >= 101 && busto <= 118) ? "2XL" :
        (bajoBusto >= 109 && bajoBusto <= 116 && busto >= 101 && busto <= 130) ? "3XL" :
        "";
...
// Añadir elementos al contenedor
conteinerInferior.append(tituloInferior, talleCintura, talleCadera, calcularTalleInferior, resultadoTalleInferior);
...
calcularTalleInferior.addEventListener("click", event => {
    ...
    // Determinar el talle con condicionales
    const talleBombacha = (cadera >= 70 && cadera <= 94 && cintura >= 58 && cintura <= 68) ? "S" :
        (cadera >= 95 && cadera <= 100 && cintura >= 60 && cintura <= 76) ? "M" :
        (cadera >= 101 && cadera <= 110 && cintura >= 69 && cintura <= 86) ? "L" :
        (cadera >= 111 && cadera <= 115 && cintura >= 77 && cintura <= 92) ? "XL" :
        (cadera >= 116 && cadera <= 125 && cintura >= 87 && cintura <= 105) ? "2XL" :
        (cadera >= 126 && cadera <= 135 && cintura >= 93 && cintura <= 115) ? "3XL" :
        "";
